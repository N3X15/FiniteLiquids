...
public class mod_NWater extends Mod
{
    ...
    public static int stW1 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SolidToWater1_BlockID", "-1");
    public static int stW2 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SolidToWater2_BlockID", "-1");
    public static int stW3 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SolidToWater3_BlockID", "-1");
    public static int stW4 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SolidToWater4_BlockID", "-1");
    public static int stW5 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SolidToWater5_BlockID", "-1");
    public static int semi1 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SemiSolidToWater1_BlockID", "-1");
    public static int semi2 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SemiSolidToWater2_BlockID", "-1");
    public static int semi3 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SemiSolidToWater3_BlockID", "-1");
    public static int semi4 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SemiSolidToWater4_BlockID", "-1");
    public static int semi5 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "SemiSolidToWater5_BlockID", "-1");
    public static int pipeLimit = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "FiniteLiquid_PipeLengthLimit", "512");
    public static int lakeLimit = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "FiniteLiquid_OceanToLakeLimit", "800");
    public static int enableRain = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "FiniteLiquid_RainCreatesFiniteLiquid", "1");
    public static int rainAmount = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "FiniteLiquid_RainLiquidAmount", "12");
    public static int checkCave = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "FiniteLiquid_CheckForCaveFlood", "1");
    ...
    public void onRegisterBlocksAndItems()
    {
        ...
        idBlock3 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "Pipe_BlockID", "215");
        idBlock4 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "Pump_BlockID", "216");
        idBlock5 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NWaterBucket_ItemID", "377");
        idBlock7 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NLava_BlockID", "218");
        idBlock8 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NLava_Still_BlockID", "219");
        idBlock9 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NLavaBucket_ItemID", "378");
        idBlock10 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "LiquidSensor_BlockID", "220");
        idBlock11 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "Grate_BlockID", "221");
        idBlock12 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "Compressor_BlockID", "224");
        idBlock13 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "CobblestoneMossy_BlockID", "222");
        idBlock14 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "StoneMossy_BlockID", "223");
        idBlock15 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "CookedChicken_ItemID", "379");
        idBlock16 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "CookedBeef_ItemID", "380");
        idBlock17 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "EmptyTank_ItemID", "381");
        idBlock18 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "WaterTank_ItemID", "382");
        idBlock19 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "AirTank_ItemID", "383");
        idBlock20 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "Goggles_ItemID", "384");
        idBlock21 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NOil_BlockID", "225");
        idBlock22 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NOil_Still_BlockID", "226");
        idBlock23 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NQSand_BlockID", "227");
        idBlock24 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NQSand_Still_BlockID", "228");
        idBlock25 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NQSandBucket_ItemID", "385");
        idBlock26 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "NOilBucket_ItemID", "386");
        idBlock27 = PReader.PropInt("/mods/DJoslin/FiniteLiquid.properties", "Water_Compressed_BlockID", "229");
        texx = new int[23];
        ...
        bucketNOil = bucketNOil.setIconIndex(api().registerItemIcon("/imgz/itembucket_oil.png", bucketNOil.shiftedIndex)).setItemName("bucketNOil").setContainerItem(Item.bucketEmpty);
        bucketNQSand = (new NSandBucket(api(), nqsand.blockID));
        bucketNQSand=bucketNQSand.setIconIndex(api().registerItemIcon("/imgz/itembucket_qsand.png",bucketNQSand.shiftedIndex)).setItemName("bucketNQSand").setContainerItem(Item.bucketEmpty);
