...
public class mod_NWater extends Mod {
    ...
    public void onRegisterBlocksAndItems() {
        ...
        /*
         * Handled by MCPMS idBlock1 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NWater_BlockID", "213"); idBlock2 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NWater_Still_BlockID", "214"); idBlock6 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NWater_Ocean_BlockID", "217"); idBlock3 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"Pipe_BlockID", "215"); idBlock4 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"Pump_BlockID", "216"); idBlock5 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NWaterBucket_ItemID", "377"); idBlock7 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NLava_BlockID", "218"); idBlock8 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NLava_Still_BlockID", "219"); idBlock9 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NLavaBucket_ItemID", "378"); idBlock10 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"LiquidSensor_BlockID", "220"); idBlock11 =
         * propReader.prop(PropertyReader.ARGU_NULL,new int[0],"Grate_BlockID", "221"); idBlock12 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"Compressor_BlockID", "224"); idBlock13 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"CobblestoneMossy_BlockID", "222"); idBlock14 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"StoneMossy_BlockID", "223"); idBlock15 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"CookedChicken_ItemID", "379"); idBlock16 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"CookedBeef_ItemID", "380"); idBlock17 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"EmptyTank_ItemID", "381"); idBlock18 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"WaterTank_ItemID", "382"); idBlock19 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"AirTank_ItemID", "383"); idBlock20 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"Goggles_ItemID", "384"); idBlock21 = propReader.prop(PropertyReader.ARGU_NULL,new
         * int[0],"NOil_BlockID", "225"); idBlock22 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NOil_Still_BlockID", "226"); idBlock23 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NQSand_BlockID", "227"); idBlock24 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NQSand_Still_BlockID", "228"); idBlock25 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NQSandBucket_ItemID", "385"); idBlock26 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"NOilBucket_ItemID", "386"); idBlock27 = propReader.prop(PropertyReader.ARGU_NULL,new int[0],"Water_Compressed_BlockID", "229");
         */
        texx = new int[31];
        int txid = 0;
        texx[0] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pipe.png"), 0);
        texx[1] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pipegrate.png"), 0);
        texx[2] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pump.png"), 0);
        texx[3] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pump_on.png"), 0);
        texx[4] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pipe_off.png"), 0);
        texx[5] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/nwater.png"), 0);
        texx[6] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/nlava.png"), 0);
        texx[7] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/iron_h1.png"), 0);
        texx[8] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/iron_h2.png"), 0);
        texx[9] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sensor_off.png"), 0);
        texx[10] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sensor_on.png"), 0);
        texx[11] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/grate_off.png"), 0);
        texx[12] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/grate_on.png"), 0);
        texx[13] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/newmoss.png"), 0);
        texx[14] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/newmossstone.png"), 0);
        texx[15] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sponge_1.png"), 0);
        texx[16] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sponge_2.png"), 0);
        texx[17] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/noil.png"), 0);
        texx[18] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/nqsand.png"), 0);
        texx[19] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/wc_off.png"), 0);
        texx[20] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/wc_on.png"), 0);
        texx[21] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/ac_off.png"), 0);
        texx[22] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/ac_on.png"), 0);
        texx[23] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/itembucket_oil.png"), 0);
        texx[24] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/itembucket_qsand.png"), 0);
        texx[25] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/tank_empty.png"), 0);
        texx[26] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/tank_air.png"), 0);
        texx[27] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/tank_water.png"), 0);
        texx[28] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/goggles.png"), 0);
        texx[29] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/cookedchicken.png"), 0);
        texx[30] = api().registerItemIcon(this.imageName(this.getClass(), "gfx/cookedbeef.png"), 0);
    ...
    public void onRegisterRecipes(ApiCraftMgr craftMgr) {
        ...
        craftMgr.addRecipe(new ItemStack(pipe, 8), new Object[] { " I ", "I I", " I ", Character.valueOf('I'), Item.ingotIron });
        craftMgr.addRecipe(new ItemStack(goggles, 1), new Object[] { "III", "IGI", "I I", Character.valueOf('I'), Item.ingotIron, Character.valueOf('G'), Block.glass });
        craftMgr.addRecipe(new ItemStack(tankEmpty, 1), new Object[] { " I ", " I ", " I ", Character.valueOf('I'), Item.ingotIron });
        craftMgr.addRecipe(new ItemStack(pump, 2), new Object[] { " I ", "IFI", " I ", Character.valueOf('I'), Item.ingotIron, Character.valueOf('F'), Block.stoneOvenIdle });
        craftMgr.addRecipe(new ItemStack(grate, 6), new Object[] { "I I", " I ", "I I", Character.valueOf('I'), Item.ingotIron });
        craftMgr.addRecipe(new ItemStack(liquidcompressor, 2), new Object[] { "I I", " F ", "I I", Character.valueOf('I'), Item.ingotIron, Character.valueOf('F'), Block.stoneOvenIdle });
        craftMgr.addRecipe(new ItemStack(liquidsensor, 4), new Object[] { "I I", " R ", "I I", Character.valueOf('I'), Item.ingotIron, Character.valueOf('R'), Item.redstone });
        craftMgr.addRecipe(new ItemStack(mossyCobble, 3), new Object[] { "   ", "CMC", "   ", Character.valueOf('C'), Block.cobblestone, Character.valueOf('M'), Block.cobblestoneMossy });
    }
    ...
    public static void dropItem(World world, double d, double d1, double d2,
            Item item) {
    ...
    public static boolean attemptPlace(World world, int i, int j, int k, int l,
            int i1, int j1) {
    ...
    public static void dealWithPistonWater(World world, int i, int j, int k,
            int l, int i1) {
        boolean flag = false;
        boolean flag2 = false;
        boolean flag3 = false;
    ...
    public static void waterPush(World world, int i, int j, int k,
    ...
    public static float compare2(World world, int i, int j, int k, int l,
            int i1, int j1) {
    ...
    public static boolean canBlockBePlacedAt(World world, int i, int j, int k,
            int l, boolean flag) {
