...
public class mod_NWater extends Mod {
    ...
    public void onRegisterBlocksAndItems() {
        ...
        texx = new int[31];
        int txid = 0;
        texx[0] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pipe.png"), txid++);
        texx[1] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pipegrate.png"), txid++);
        texx[2] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pump.png"), txid++);
        texx[3] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pump_on.png"), txid++);
        texx[4] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/pipe_off.png"), txid++);
        texx[5] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/nwater.png"), txid++);
        texx[6] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/nlava.png"), txid++);
        texx[7] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/iron_h1.png"), txid++);
        texx[8] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/iron_h2.png"), txid++);
        texx[9] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sensor_off.png"), txid++);
        texx[10] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sensor_on.png"), txid++);
        texx[11] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/grate_off.png"), txid++);
        texx[12] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/grate_on.png"), txid++);
        texx[13] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/newmoss.png"), txid++);
        texx[14] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/newmossstone.png"), txid++);
        texx[15] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sponge_1.png"), txid++);
        texx[16] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/sponge_2.png"), txid++);
        texx[17] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/noil.png"), txid++);
        texx[18] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/nqsand.png"), txid++);
        texx[19] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/wc_off.png"), txid++);
        texx[20] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/wc_on.png"), txid++);
        texx[21] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/ac_off.png"), txid++);
        texx[22] = api().registerBlockTexture(this.imageName(this.getClass(), "gfx/ac_on.png"), txid++);
